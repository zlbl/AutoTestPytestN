...
def test_order_applyRepayAll():
    ...
    if r.status_code == 200:
        ...
        if code == 200:
            print('创建提前结清申请订单成功')
            global orderId4
            orderId4 = res_json['data']
            print('orderId4 is ', orderId4)
...
# 请求api接口
api_workflow9 = '/schedule/workflow'

def test_schedule_workflow9():
    """
    TOB_执行工作流（额度申请，用款申请，提前还款申请，展期申请）
    """
    # 请求头
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_workflow9
...
# 请求api接口
api_listByOrderId5 = '/innerapi/approval/listByOrderId'


def test_approval_listByOrderId5():
    """
    TOB_产融贷审核记录查询
    """
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_listByOrderId5
    ...
    if r.status_code == 200:
        ...
        if code == 200:
            ...
            approvalId20 = res_json['data'][0]['approvalId']
            approvalId21 = res_json['data'][1]['approvalId']
            approvalId22 = res_json['data'][2]['approvalId']
            approvalId23 = res_json['data'][3]['approvalId']
            approvalId24 = res_json['data'][4]['approvalId']
            print('approvalId20 is ', approvalId20)
            print('approvalId21 is ', approvalId21)
            print('approvalId22 is ', approvalId22)
            print('approvalId23 is ', approvalId23)
            print('approvalId24 is ', approvalId24)
...
# 请求api接口
api_do21 = '/innerapi/approval/do'


def test_approval_do21():
    """
    TOB_产融贷任务审批1
    """
    # 请求头
    ...
    # 参数变量
    params_approval = {
        "approvalId": approvalId20,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do21
...
# 请求api接口
api_do22 = '/innerapi/approval/do'


def test_approval_do22():
    """
    TOB_产融贷任务审批2
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId21,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do22
...
# 请求api接口
api_do23 = '/innerapi/approval/do'


def test_approval_do23():
    """
    TOB_产融贷任务审批3
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId22,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do23
...
# 请求api接口
api_do24 = '/innerapi/approval/do'


def test_approval_do24():
    """
    TOB_产融贷任务审批4
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId23,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do24
...
# 请求api接口
api_do25 = '/innerapi/approval/do'


def test_approval_do25():
    """
    TOB_产融贷任务审批5
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId24,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do25
...
# 请求api接口
api_workflow10 = '/schedule/workflow'


def test_schedule_workflow10():
    """
    TOB_执行工作流（额度申请，用款申请，提前还款申请，展期申请）
    """
    # 请求头
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_workflow10
...
# 请求api接口
api_doAdvanceRepayment2 = '/innerapi/repay/doAdvanceRepayment'

def test_repay_doAdvanceRepayment2():
    """
    TOB_产融贷提前结清还款登记
    """
    # 请求头
    ...
    params = {
      "debtInfoId": debtInfoId,
      "accountName": "提前结清还款登记账户名称1",
      "accountNo": "提前结清还款登记账号1",
      "offlineRechargeType": "Manual",
      "offlineRepayTime": "",
      "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_doAdvanceRepayment2
    ...
    if r.status_code == 200:
        ...
        if code == 200:
            ...
            raise Exception('提前结清还款登记异常', res_json['code'], ' msg is ',
                            res_json['errorMsg'])
...
# 请求api接口
api_getByEnterpriseId2 = '/innerapi/debtinfo/getByEnterpriseId'


def test_debtinfo_getByEnterpriseId2():
    """
    TOB_产融贷根据企业ID获得企业的债权列表
    """
    # 请求头
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_getByEnterpriseId2
    ...
    if r.status_code == 200:
        ...
        if code == 200:
            print('获得企业债权列表成功')
            global debtInfoId2
            debtInfoId2 = res_json['data'][0]['debtInfoId']
            print('debtInfoId2 is ', debtInfoId2)
            global balanceAmount
            balanceAmount = res_json['data'][0]['balanceAmount']
...
# 请求api接口
api_applyContinueAll = '/innerapi/order/applyContinue'


def test_order_applyContinueAll():
    """
    TOB_产融贷创建全额展期申请订单
    """
    # 请求头
    ...
    params = {
      "periodUnit": "MONTH",
      "periodValue": "3",
      "repaymentType": "MONTH_REPAY_MONTH_INTEREST",
      "startInterestOffset": "0",
      "rateValue": "12",
      "overdueRateValue": "12",
      "continueAmount": balanceAmount,
      "debtorId": enterpriseId,
      "debtInfoId": debtInfoId2,
      "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_applyContinueAll
    ...
    if r.status_code == 200:
        ...
        if code == 200:
            print('创建全额展期申请订单成功')
            global orderId5
            orderId5 = res_json['data']
            print('orderId5 is ', orderId5)

        else:
            raise Exception('创建全额展期申请订单异常', res_json['code'], ' msg is ',
                            res_json['errorMsg'])
...
# 请求api接口
api_workflow11 = '/schedule/workflow'

def test_schedule_workflow11():
    """
    TOB_执行工作流（额度申请，用款申请，提前还款申请，展期申请）
    """
    # 请求头
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_workflow11
...
# 请求api接口
api_listByOrderId6 = '/innerapi/approval/listByOrderId'


def test_approval_listByOrderId6():
    """
    TOB_产融贷审核记录查询
    """
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_listByOrderId6
    ...
    if r.status_code == 200:
        ...
        if code == 200:
            ...
            approvalId25 = res_json['data'][0]['approvalId']
            approvalId26 = res_json['data'][1]['approvalId']
            approvalId27 = res_json['data'][2]['approvalId']
            approvalId28 = res_json['data'][3]['approvalId']
            approvalId29 = res_json['data'][4]['approvalId']
            print('approvalId25 is ', approvalId25)
            print('approvalId26 is ', approvalId26)
            print('approvalId27 is ', approvalId27)
            print('approvalId28 is ', approvalId28)
            print('approvalId29 is ', approvalId29)
...
# 请求api接口
api_do26 = '/innerapi/approval/do'


def test_approval_do26():
    """
    TOB_产融贷任务审批1
    """
    # 请求头
    ...
    # 参数变量
    params_approval = {
        "approvalId": approvalId25,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do26
...
# 请求api接口
api_do27 = '/innerapi/approval/do'


def test_approval_do27():
    """
    TOB_产融贷任务审批2
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId26,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do27
...
# 请求api接口
api_do28 = '/innerapi/approval/do'


def test_approval_do28():
    """
    TOB_产融贷任务审批3
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId27,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do28
...
# 请求api接口
api_do29 = '/innerapi/approval/do'


def test_approval_do29():
    """
    TOB_产融贷任务审批4
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId28,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do29
...
# 请求api接口
api_do30 = '/innerapi/approval/do'


def test_approval_do30():
    """
    TOB_产融贷任务审批5
    """
    # 请求头
    ...
    # 参数变量
    params = {
        "approvalId": approvalId29,
        "approvalResult": "Agree",
        "approvalDesc": "",
        "merchantType": "LoanEnterprise"
    }
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_do30
...
# 请求api接口
api_workflow12 = '/schedule/workflow'


def test_schedule_workflow12():
    """
    TOB_执行工作流（额度申请，用款申请，提前还款申请，展期申请）
    """
    # 请求头
    ...
    # 参数地址
    url = "http://api.loan.test.hljzxxd.com/gateway" + api_workflow12
