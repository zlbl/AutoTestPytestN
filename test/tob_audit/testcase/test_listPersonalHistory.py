...
from test.tob_audit.data.auditParams import listPersonalHistory_params
import requests
import time
...
tob_audit_port = '8082'
tob_audit_interface = '/audit/listPersonalHistory'
...
def test_getNowAuditJob():
    ...
    #参数变量
    params = {
        'pageSize': listPersonalHistory_params.pageSize,
        'pageNumber' : listPersonalHistory_params.pageNumber,
    }

    audit_listPersonalHistory_api = 'http://' + tob_audit_host + ':' + tob_audit_port + tob_audit_interface

  #发起请求
    r = requests.post(url=audit_listPersonalHistory_api,json=params,headers = headers)
