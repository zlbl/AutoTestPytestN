...
tob_audit_port = '8082'
tob_audit_interface = '/audit/enum/all'
...
def test_enum_all():
    ...
    audit_enum_all = 'http://' + tob_audit_host + ':' + tob_audit_port + tob_audit_interface

    r = requests.post(audit_enum_all, json=params, headers=headers)
