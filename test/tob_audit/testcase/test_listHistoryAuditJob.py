...
tob_audit_port = '8082'
tob_audit_uri = '/audit/listHistoryAuditJob'
...
def test_listHistoryAuditJob():
    ...
    #请求地址
    listHistoryAuditJob_api = 'http://' + tob_audit_host + ':' + tob_audit_port + tob_audit_uri

    r = requests.post(listHistoryAuditJob_api, json=params, headers=headers)
