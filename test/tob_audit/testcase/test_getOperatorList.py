...
tob_audit_port = '8082'
tob_audit_uri = '/audit/operator/getOperatorList'
...
def test_getOperatorList():
    ...
    #请求地址
    getOperatorList_api = 'http://' + tob_audit_host + ':' + tob_audit_port + tob_audit_uri

    r = requests.post(getOperatorList_api, json=params, headers=headers)
