...
tob_audit_port = '8082'
tob_audit_uri = '/audit/user/loginOut'
...
def test_loginOut():
    ...
    #请求地址
    loginOut_api = 'http://' + tob_audit_host + ':' + tob_audit_port + tob_audit_uri

    r = requests.post(loginOut_api, json=params, headers=headers)
