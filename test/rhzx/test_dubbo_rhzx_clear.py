...
def test__rhzx_clear():
    ...
    CreditReasonRequestDto = {}
    CreditReasonRequestDto['cardNo'] = '610524199308309913'
    data = {}

    data['userId'] = 2003102962
    CreditReasonRequestDto['reason'] = '02'
    CreditReasonRequestDto['data'] = data
    CreditReasonRequestDto['days'] = 30
    CreditReasonRequestDto['username'] = '唐小星'


    # 转成字符串，如果有多个对象，就像普通对象一样，添加多个，比如
    # json.dumps(operatorDTO) + ',' +
    # json.dumps(operatorDTO2) + ',12121212121212'
    param = json.dumps(CreditReasonRequestDto)
